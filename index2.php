...
<!-- Mirrored from themesbrand.com/lexa/html/vertical-teal/pages-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Mar 2020 06:51:44 GMT -->
<head>
<meta charset="utf-8">
...
<link href="assets3/css/metismenu.min.css" rel="stylesheet" type="text/css">
...
<div class="wrapper-page">
	<div class="card">
		<div class="card-body">
			...
			<div class="p-3">
				...
				<form class="form-horizontal m-t-30" method="post" action="proses_login2.php">
					<div class="form-group">
						<label>username</label><input type="text" class="form-control" id="username" name="username" placeholder="Enter Username..."></div>
					<div class="form-group">
						<label>Password</label><input type="password" class="form-control" id="password" name="password" placeholder="Enter password"></div>
	...
	<div class="m-t-40 text-center">
		<p>
			Don't have an account ? <a href="pages-register.html" class="text-primary">Signup Now</a>
		</p>
		<p>
			© 2021 SAN
		</p>
...
<script src="assets3/js/waves.min.js"></script>
<script src="assets3/plugins/jquery-sparkline/jquery.sparkline.min.js"></script>
<!-- App js -->
