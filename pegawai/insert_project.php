...
if (isset($_POST['insertdata'])) {
    ...
    $query = "INSERT INTO project VALUES ('','$nama_project','$deskripsii','$id_kategori', '$id_case', '$id_tracking', '$id_pegawai', '$id_priority', '$nominal', '$start_date', '$due_date', '$is_delete', '$created_by', '$created_at', '$updated_by','$updated_at')";
