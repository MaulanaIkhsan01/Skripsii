                ...
                <div class="card-body">
                  <div class="form-group col-md-6">
                      <dl>
                          ...
                          <dd><?php echo $result['nama_project']; ?></dd>
                      </dl>
                  </div>
                  <div class="form-group col-md-6">
                      <dl>
                          <dt><b class="border-primary">Description</b></dt>
                          <dd><?php echo $result['deskripsii']; ?></dd>
                      </dl>
                  </div>
                    <div class="form-group col-md-6">
                        <dl>
                            <dt><b class="border-bottom ml-15 border-primary">Start Date</b></dt>
                            <dd><?php echo date("F d, Y",strtotime($result['start_date'])); ?></dd>
                        </dl>
                    </div>
                    <div class="form-group col-md-6">
                      <dl>
                          <dt><b class="border-right mr-25 border-primary">Start Date</b></dt>
                          <dd><?php echo date("F d, Y",strtotime($result['due_date'])); ?></dd>
                      </dl>  
                    </div>
                  <div class="form-group col-md-6">
                      <dl>
                          <dt><b class="border-right ml-15 border-primary">Assignee</b></dt>
                          <dd><?php echo $result['nama_pegawai']; ?></dd>
                      </dl>  
                      <dl>
                          <dt><b class="border-bottom ml-15 border-primary">Status</b></dt>
                          <dd><?php echo $result['nama_tracking']; ?></dd>
                      </dl>  
                  </div>  
