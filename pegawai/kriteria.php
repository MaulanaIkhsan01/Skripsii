                    ...
                    ?>
                      <table class="table table-striped" id="table-1">
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?php echo $d['kriteria']; ?></td>
                            <td class="text-center"><?php echo $d['bobot']; ?></td>
                            <td class="text-center"><?php echo $d['bobot'] / 100; ?></td>
                            <td align="center">
                            <a href="edit_kriteria.php?id=<?php echo $d['id_kriteria']; ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
                            <a href="delete_kriteria.php?id=<?php echo $d['id_kriteria']; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                            </td>
                            </tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Data Kriteria</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="insert_kriteria.php" method="post" class="form-user" enctype="multipart/form-data">
