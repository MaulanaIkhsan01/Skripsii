            ...
            foreach ($rows as $row) : ?>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <a href="knnkriteria_ubah.php?&ID=<?= $row->id_atribut ?>"
                                                                class="btn btn-info btn-sm"><i
                                                                    class="fa fa-edit"></i></a>
                                                            <a href="knnkriteria_hapus.php?id_atribut=<?= $row->id_atribut ?>"
    ...
    <div class="modal fade" id="modalTambah" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <?php if ($_POST) include 'aksikriteria.php' ?>

                <form method="post" class="form-user" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="form-group">
                            <label>ID Atribut <span class="text-danger">*</span></label>
                            <input class="form-control" type="text" name="id_atribut"
                                value="<?= set_value('id_atribut', kode_oto('id_atribut', 'tb_atribut', 'A', 2)) ?>" />
                        </div>
                        <div class="form-group">
                            <label>Nama Atribut <span class="text-danger">*</span></label>
                            <input class="form-control" type="text" name="nama_atribut"
                                value="<?= set_value('nama_atribut') ?>" />
                        </div>
                        <div class="form-group">
                        ...
                        <div>
                            <button class="btn btn-primary m-t-15 waves-effect"><span
                                    ></span> Simpan</button>
