                      ...
                      <table class="table table-striped" id="table-1">
                        <thead>
                          <tr>
                            ...
                            <th class="text-center">Konsep Diri</th>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?php echo $d['konsep_diri']; ?></td>
                            <td class="text-center"><?php echo $d['pengetahuan']; ?></td>
                            <td class="text-center"><?php echo $d['keterampilan']; ?></td>
                            <td class="text-center"><?php echo $d['penilaian']; ?></td>
                            <!-- <td align="center">
