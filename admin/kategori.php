                    ...
                    ?>
                      <table class="table table-striped" id="table-1">
                        ...
                        <tr>
                            ...
                            <td align="center">
                            <a href="edit_kategori.php?id=<?php echo $d['id_kategori']; ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i>Edit</a>
                            <a href="delete_kategori.php?id=<?php echo $d['id_kategori']; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i>Delete</a>
                            </td>
                            </tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Data Kategori</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="insert_kategori.php" method="post" class="form-user" enctype="multipart/form-data">
