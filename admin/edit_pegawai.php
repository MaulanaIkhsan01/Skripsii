        ...
        <section class="section">
          <div class="section-body">
            <div class="row">
              <div class="col-12">
                <div class="card">
                <form action="update_pegawai.php" method="post" class="form-user" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" name="nama_pegawai" value="<?php echo $result['nama_pegawai']; ?>" id="nama_pegawai" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label class="control-label" for="username">Username</label>
                        <input type="text" name="username" value="<?php echo $result['username']; ?>" class="form-control" id="username" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="tempatlahir" value="<?php echo $result['tempatlahir']; ?>" class="form-control" id="tempat_lahir" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="tel" value="<?php echo $result['tel']; ?>" class="form-control" id="tel" required>
                    </div>
                    <div class="form-group">
                        <label class="control-label" for="email">Email</label>
                        <input type="text" name="email" value="<?php echo $result['email']; ?>" class="form-control" id="email" required>
                    </div>
                    <div class="form-group">
                        <label class="control-label" for="alamat">Alamat</label>
                        <input type="textarea" name="alamat" value="<?php echo $result['alamat']; ?>" class="form-control" id="alamat" required>
                    </div>
                    <!-- <div class="form-group">
                  ...
                  <a href="pegawai.php" class="btn btn-danger m-t-15 waves-effect">Cancel</a>
