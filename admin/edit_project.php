              ...
              <div class="col-12">
                ...
                <form action="update_project.php" method="post" class="form-user" enctype="multipart/form-data">
                  <div class="card-header">
                    ...
                    include '../koneksi.php';
                    $query = "SELECT 
                    project.nama_project, project.deskripsii, project.id_project, project.start_date, project.due_date, 
                    kategori.nama_kategori, kategori.id_kategori,
                    project_case.nama_case, project_case.id_case,
                    tb_tracking.nama_tracking, tb_tracking.id_tracking,
                    pegawai.nama_pegawai, pegawai.id_pegawai,
                    tb_priority.nama_priority, tb_priority.id_priority
                    FROM project 
                    JOIN kategori ON kategori.id_kategori = project.id_kategori
                    JOIN project_case ON project_case.id_case = project.id_case
                    JOIN tb_tracking ON tb_tracking.id_tracking = project.id_tracking
                    JOIN pegawai ON pegawai.id_pegawai = project.id_pegawai
                    JOIN tb_priority ON tb_priority.id_priority = project.id_priority
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="control-label" for="id_kategori">Kategori {<?php echo $result['nama_kategori']; ?>}</label>
                            <select name="id_kategori" id="id_kategori" class="form-control" required>
                                <option value="<?php echo $result['id_kategori']; ?>"> --- Pilih kategori --- </option>
                                <?php
                        ...
                        <div class="form-group">
                            <label class="control-label" for="id_case">Case {<?php echo $result['nama_case']; ?>}</label>
                            <select name="id_case" id="id_case" class="form-control" required>
                                <option value="<?php echo $result['id_case']; ?>"> --- Pilih Case --- </option>
                                <?php
                        ...
                        <div class="form-group">
                            <label class="control-label" for="id_tracking">Tracker {<?php echo $result['nama_tracking']; ?>}</label>
                            <select name="id_tracking" id="id_tracking" class="form-control" required>
                                <option value="<?php echo $result['id_tracking']; ?>"> --- Pilih Tracker --- </option>
                                <?php
                        ...
                        <div class="form-group">
                            <label class="control-label" for="assignee">Assignee {<?php echo $result['nama_pegawai']; ?>}</label>
                            <select name="id_pegawai" id="id_pegawai" class="form-control" required>
                                <option value="<?php echo $result['id_pegawai']; ?>"> --- Pilih Assignee --- </option>
                                <?php
                        ...
                        <div class="form-group">
                            <label class="control-label" for="id_priority">Priority {<?php echo $result['nama_priority']; ?>}</label>
                            <select name="id_priority" id="id_priority" class="form-control" required>
                                <option value="<?php echo $result['id_priority']; ?>"> --- Pilih Priority --- </option>
                                <?php
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="start_date" class="form-control" id="start_date" value="<?php echo $result['start_date']; ?>" required>
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="due_date">Due Date</label>
                            <input type="date" name="due_date" class="form-control" id="due_date" value="<?php echo $result['due_date']; ?>" required>
                        </div>
