                      ...
                      <tbody>
                        ...
                        while ($data = mysqli_fetch_array($sql_pegawai)) { ?>
                          <tr>
                            ...
                            <td class="text-center"><?php echo date("d F Y", strtotime($data['tanggallahir'])); ?></td>
                            ...
                            <td class="text-center"><?php echo $data['tel']; ?></td>
                            <td class="text-center"><?php echo $data['email']; ?></td>
                            <td class="text-center"><?php echo $data['alamat']; ?></td>
                            <td class="text-center"><img class="img-profile rounded-circle" src="../assets/img/profile/<?php echo $data['image']; ?>" style="width: 80px;"></td>
                            <td align="center">
                              <a href="edit_pegawai.php?id=<?php echo $data['id_pegawai']; ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
                              <a href="delete_pegawai.php?id=<?php echo $data['id_pegawai']; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                            </td>
                          </tr>
                        <?php
                        } ?>
