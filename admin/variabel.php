                    ...
                    ?>
                      <table class="table table-striped" id="table-1">
                        ...
                        <tr>
                            ...
                            <td class="text-center"><?php echo $d['nama_variabel']; ?></td>
                            <td class="text-center"><?php echo $d['kurang']; ?></td>
                            <td class="text-center"><?php echo $d['cukup']; ?></td>
                            <td class="text-center"><?php echo $d['baik']; ?></td>
                            <!-- <td align="center">
                            <a href="edit_jabatan.php?id=<?php echo $d['id_jabatan']; ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i>Edit</a>
                            <a href="delete_jabatan.php?id=<?php echo $d['id_jabatan']; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i>Delete</a>
                            </td> -->
                            </tr>
            ...
            <div class="modal-content">
                ...
                <form action="insert_jabatan.php" method="post" class="form-user" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="control-label" for="job_desc">JobDesk</label>
                            <input type="text" name="job_desc" class="form-control" id="job_desc" required>
                        </div>
                        <div>
